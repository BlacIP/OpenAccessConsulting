        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              From a small consultancy to a leading professional services firm, here's our story.
            </p>
          </div>
          <div className="space-y-8">
            {[
              {
                ...
                description: 'Started with a vision to transform HR practices and provide comprehensive business solutions.',
              },
              {
                year: '2012',
                title: 'Expanded Immigration Services',
                description: 'Added expatriate and immigration services to support international business growth.',
              },
              {
                year: '2016',
                title: 'Business Support Solutions',
                description: 'Launched comprehensive business support and outsourcing services.',
              },
              {
                year: '2020',
                title: 'Digital Transformation',
                description: 'Adapted our services for remote work and digital-first business strategies.',
              },
              {
                year: '2024',
                title: 'Industry Recognition',
                description: 'Recognized as a leading professional services firm with over 500 successful client partnerships.',
              },
            ].map((milestone, index) => (

...
const Services = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-[#393235] via-[#4a3f42] to-[#393235] text-white py-20 -mx-22">
        <div className="max-w-7xl mx-auto px-4 sm:px-10 lg:px-28">
          <div className="text-center">
            <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-[#FDED8F]">
              Our Services
            </h1>
      ...
      <section className="py-20 bg-gradient-to-br from-[#393235] via-[#4a3f42] to-[#393235] text-white -mx-22">
        <div className="max-w-7xl mx-auto px-4 sm:px-10 lg:px-28">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-[#FDED8F]">
            ...
            <div className="bg-[#FDED8F] text-[#393235] px-6 py-3 rounded-full text-lg font-bold inline-block mb-4">
              Price: ₦120,000
            </div>
            <p className="text-gray-300">Second Edition - Virtual Training</p>
          </div>

          {/* Training Details */}
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-16">
            <div className="bg-white/10 backdrop-blur p-8 rounded-xl text-center">
              <Calendar className="h-12 w-12 text-[#FDED8F] mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">Start Date</h3>
              <p className="text-gray-200">2nd August, 2025</p>
              <p className="text-sm text-gray-300">Saturday Only</p>
            </div>
            <div className="bg-white/10 backdrop-blur p-8 rounded-xl text-center">
              <Clock className="h-12 w-12 text-[#FDED8F] mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">Time</h3>
              <p className="text-gray-200">10am - 1pm</p>
              <p className="text-sm text-gray-300">Weekly sessions</p>
            </div>
            <div className="bg-white/10 backdrop-blur p-8 rounded-xl text-center">
              <Users className="h-12 w-12 text-[#FDED8F] mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">Format</h3>
              <p className="text-gray-200">Virtual Training</p>
              <p className="text-sm text-gray-300">Online sessions</p>
            </div>
            <div className="bg-white/10 backdrop-blur p-8 rounded-xl text-center">
              <Award className="h-12 w-12 text-[#FDED8F] mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">Duration</h3>
              <p className="text-gray-200">12 Weeks</p>
              <p className="text-sm text-gray-300">Comprehensive program</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white/10 backdrop-blur p-8 rounded-xl">
              <h3 className="text-xl font-bold mb-6 text-[#FDED8F]">What You'll Learn:</h3>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={index} className="flex items-center space-x-3">
                    <CheckCircle className="h-5 w-5 text-[#FDED8F]" />
            ...
            <div className="bg-white/10 backdrop-blur p-8 rounded-xl">
              <h3 className="text-xl font-bold mb-6 text-[#FDED8F]">Who Should Attend:</h3>
              <ul className="space-y-3">
                {[
          ...
          <div className="text-center">
            <a
              ...
              className="bg-[#FDED8F] text-[#393235] px-12 py-4 rounded-lg font-semibold hover:bg-[#fce76b] transition-colors inline-flex items-center text-lg group mr-4"
            >
              Register Now
              <ArrowRight className="ml-2 h-6 w-6 group-hover:translate-x-1 transition-transform" />
            </a>
            <button className="border-2 border-[#FDED8F]/30 text-[#FDED8F] px-8 py-4 rounded-lg font-semibold hover:bg-[#FDED8F]/10 transition-colors inline-flex items-center">
              <Download className="mr-2 h-5 w-5" />
              Download Brochure
            </button>
            <div className="mt-6 text-center">
              <p className="text-gray-300 mb-2">For enquiries & Registration:</p>
              <p className="text-[#FDED8F] font-semibold">info@openaccessconsult.com</p>
              <p className="text-[#FDED8F] font-semibold">08066861023</p>
            </div>
          </div>
        </div>
      </section>
